...
Scenario: Crear un Tag con una descripción de x-card muy larga
  ...
  When I try to create a tag with a x-card long description
  Then An alert with the message "Validation error, cannot save tag. Validation failed for twitter_description." is displayed
